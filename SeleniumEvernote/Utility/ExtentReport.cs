...
namespace SpecFlowBDDAutomationFramework.Utility
{
    public class ExtentReport
    {
        ...
        public static void ExtentReportInit()
        {
            ...
            htmlReporter.Config.ReportName = "Automation Evernote Test Report";
            htmlReporter.Config.DocumentTitle = "Automation Evernote Test Report";
            htmlReporter.Config.Theme = Theme.Standard;
            htmlReporter.Start();

            _extentReports = new ExtentReports();
            _extentReports.AttachReporter(htmlReporter);
            _extentReports.AddSystemInfo("Application", "Evernote");
